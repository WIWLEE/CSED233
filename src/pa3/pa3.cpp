...
/*
    ...
    Description:
        Implement a function that sorts a given array using the Quick sort algorithm \\
        with in-place partitioning in ascending order.
        Use the first element at the pivot.
    ...
    Output:
        Every value in the array whenever swapping happens including the initial step, \\
...
/*
    ...
    Description:
        ...
        You don't need to consider the maximum length of linked list, deletion of a key \\
        which does not exist or multiple insertions of the same key.
        You can modify open_hash_function.cpp, open_hash_function.h, open_hash_table.cpp \\
        and open_hash_table.h files for this problem.
...
/*
    ...
    Description:
        ...
        TODO: Implementation ClosedHashTable::insert & ClosedHashTable::erase functions
